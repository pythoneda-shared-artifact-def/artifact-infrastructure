# artifact-infrastructure/flake.nix
#
# This file packages pythoneda-shared-artifact/artifact-infrastructure as a Nix flake.
#
# Copyright (C) 2023-today rydnr's pythoneda-shared-artifact/artifact-infrastructure-artifact
#
...
{
  description = "Shared kernel for artifact infrastructure layers in artifacts";
  inputs = rec {
    ...
    pythoneda-shared-artifact-artifact-events-infrastructure = {
      ...
      url =
        "github:pythoneda-shared-artifact/artifact-events-infrastructure-artifact/0.0.2?dir=artifact-events-infrastructure";
    };
    pythoneda-shared-pythoneda-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.2";
        sha256 = "1pjpxd0dc3isz4r39d7y099gmgdw0l3nmfbr5nnxvhr2wca82j03";
        pname = "${org}-${repo}";
