...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-artifact-events = {
      ...
      url = "github:pythoneda-shared-artifact-def/artifact-events/0.0.39";
    };
    pythoneda-shared-artifact-artifact-events-infrastructure = {
      ...
      url =
        "github:pythoneda-shared-artifact-def/artifact-events-infrastructure/0.0.33";
    };
    pythoneda-shared-pythonlang-banner = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixos.follows = "nixos";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        version = "0.0.6";
        sha256 = "1api4pgxpbapvq5mkqfad5sfx1w36gm7znz8y0zzw0g56y31j9dh";
        pname = "${org}-${repo}";
